...
mongoose.connect("mongodb+srv://vijju:vijju@cluster0-ex1xq.mongodb.net/bookstore?retryWrites=true&w=majority", 
...
function sendmail(email,name,res)
{
	...
	var mailOptions = {
	  ...
	  //html : '<a href="http://localhost:3000/confirmemail?email='+email+'" return false;>Click me</a>'
	  html : '<div>Hi '+name+',</div><p> Thank you for Signing up. Please click the link below to verify your email address.</p><b><a href="http://localhost:3000/confirmemail?email='+email+'" return false;>Verification link</a></b>'
	};	
